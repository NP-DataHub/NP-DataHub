  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
      <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl bg-white">
        <button onClick={onClose} className="float-right text-gray-700">Close</button>
        ...
        <p className="text-center text-sm">Already have an account? <a href='#' onClick={onSwitchToLogin} className="hover:underline font-bold">Sign in</a></p>
        ...
        <button
          ...
          {isSigningIn ? 'Registering...' : 'Continue with Google'}
        </button>
      </div>
    </div>
  );
