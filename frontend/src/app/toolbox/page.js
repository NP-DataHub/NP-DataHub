                ...
                <div className = "flex-grow">
                    <div className = {`flex-col px-10 ${isDarkMode ? "bg-[#21222D] text-white" : "bg-[#f9f9f9] text-black"} rounded-md mx-10 p-10 font-sans mt-12 flex-grow mb-12`} >
                        ...
                        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
                            ...
                            <div className={`${isDarkMode ? "bg-[#171821] text-white" : "bg-[#ffffff] text-black"} relative z-10 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300`}
                            ...
                            <div
                                className={`z-10 relative p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 cursor-pointer ${
                                    selectedSection === "News Feed" ? isDarkMode ? "bg-[#34344c] text-white" : "bg-[#c9c9c9] text-black" : isDarkMode ? "bg-[#171821] text-white" : "bg-[#ffffff] text-black"
                                }`}
                                onClick={() =>
                                    setSelectedSection(
                            ...
                            <div
                                ...
                                <svg className = "mb-4" width="36" height="39" viewBox="0 0 20 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M5.1202 25.17C6.95076 27 9.89798 27 15.7896 27C21.6827 27 24.6285 27 26.4591 25.1687C28.2896 23.34 28.2896 20.3925 28.2896 14.5C28.2896 8.6075 28.2896 5.66125 26.4591 3.83C24.6285 2 21.6813 2 15.7896 2C9.89659 2 6.95076 2 5.1202 3.83C3.28965 5.6625 3.28965 8.6075 3.28965 14.5C3.28965 20.3925 3.28965 23.34 5.1202 25.17Z" stroke={isDarkMode ? "#A9DFD8" : "#007AFF"} stroke-width="1.5"/>
                                    <path d="M8.8452 9.5C8.8452 8.91875 8.8452 8.62875 8.91604 8.39C9.01075 8.07233 9.19664 7.78268 9.45505 7.55011C9.71346 7.31754 10.0353 7.15024 10.3883 7.065C10.6563 7 10.9785 7 11.623 7H19.9563C20.6021 7 20.9244 7 21.1896 7.06375C21.5426 7.14899 21.8644 7.31629 22.1229 7.54886C22.3813 7.78143 22.5672 8.07108 22.6619 8.38875C22.7341 8.63 22.7341 8.92 22.7341 9.5C22.7341 10.08 22.7341 10.3712 22.6633 10.61C22.5685 10.9277 22.3827 11.2173 22.1242 11.4499C21.8658 11.6825 21.544 11.8498 21.191 11.935C20.9244 12 20.6008 12 19.9563 12H11.623C10.9771 12 10.6549 12 10.3896 11.9363C10.0367 11.851 9.71485 11.6837 9.45644 11.4511C9.19803 11.2186 9.01214 10.9289 8.91743 10.6112C8.8452 10.37 8.8452 10.08 8.8452 9.5Z" stroke={isDarkMode ? "#A9DFD8" : "#007AFF"} stroke-width="1.5"/>
                                    <path d="M11.123 15.75C11.123 16.116 10.7759 16.5 10.2341 16.5C9.69232 16.5 9.3452 16.116 9.3452 15.75C9.3452 15.384 9.69232 15 10.2341 15C10.7759 15 11.123 15.384 11.123 15.75Z" fill={isDarkMode ? "#A9DFD8" : "#007AFF"} stroke={isDarkMode ? "#A9DFD8" : "#007AFF"}/>
                                    <path d="M11.123 20.75C11.123 21.116 10.7759 21.5 10.2341 21.5C9.69232 21.5 9.3452 21.116 9.3452 20.75C9.3452 20.384 9.69232 20 10.2341 20C10.7759 20 11.123 20.384 11.123 20.75Z" fill={isDarkMode ? "#A9DFD8" : "#007AFF"} stroke={isDarkMode ? "#A9DFD8" : "#007AFF"}/>
                                    <path d="M16.6785 15.75C16.6785 16.116 16.3314 16.5 15.7896 16.5C15.2479 16.5 14.9008 16.116 14.9008 15.75C14.9008 15.384 15.2479 15 15.7896 15C16.3314 15 16.6785 15.384 16.6785 15.75Z" fill={isDarkMode ? "#A9DFD8" : "#007AFF"} stroke={isDarkMode ? "#A9DFD8" : "#007AFF"}/>
                                    <path d="M16.6785 20.75C16.6785 21.116 16.3314 21.5 15.7896 21.5C15.2479 21.5 14.9008 21.116 14.9008 20.75C14.9008 20.384 15.2479 20 15.7896 20C16.3314 20 16.6785 20.384 16.6785 20.75Z" fill={isDarkMode ? "#A9DFD8" : "#007AFF"} stroke={isDarkMode ? "#A9DFD8" : "#007AFF"}/>
                                    <path d="M22.2341 15.75C22.2341 16.116 21.887 16.5 21.3452 16.5C20.8034 16.5 20.4563 16.116 20.4563 15.75C20.4563 15.384 20.8034 15 21.3452 15C21.887 15 22.2341 15.384 22.2341 15.75Z" fill={isDarkMode ? "#A9DFD8" : "#007AFF"} stroke={isDarkMode ? "#A9DFD8" : "#007AFF"}/>
                                    <path d="M22.2341 20.75C22.2341 21.116 21.887 21.5 21.3452 21.5C20.8034 21.5 20.4563 21.116 20.4563 20.75C20.4563 20.384 20.8034 20 21.3452 20C21.887 20 22.2341 20.384 22.2341 20.75Z" fill={isDarkMode ? "#A9DFD8" : "#007AFF"} stroke={isDarkMode ? "#A9DFD8" : "#007AFF"}/>
                                    </g>
                                    <defs>
                                ...
                                <h2 className={`text-xl font-semibold mb-2 ${isDarkMode ? "text-[#A9DFD8]" : "text-[#007AFF]"}`} >
                                    CALCULATOR
                                </h2>
