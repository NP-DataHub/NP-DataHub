...
graphs, _ = dgl.data.load_graphs('EZ.dgl')
g = graphs[0]
...
print(g.ndata['Name'][0:5])
print(g.ndata['City'][0:5])
print(g.ndata['State'][0:5])
print(g.ndata['Zipcode'][0:5])
...
model = GraphSAGE(train_g.ndata["State"].shape[0], 130)
...
for e in range(100):
    # forward
    h = model(train_g, train_g.ndata["State"])
